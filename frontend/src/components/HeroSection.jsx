import { Container, Stack, Flex, Box, Heading, Text, Button, Image, 
        ...
        >
          ...
          >
            <MotionImage
              ...
              initial={{ width: '50%', x: '50vw', opacity: 0, y: 20, rotateY: 0 }}
              animate={{ width: '100%', x: 0, opacity: 1, y: 0, rotateY: 360 }}
              margin={'auto'}
              transition={{ duration: 1, origin: 1.2 }}
              w={'100%'}
              h={{ lg: '80%', base: '65%' }}
              src={"/assets/Hero-Section/Cricket-Robo-NoBg2.png"}
            />
          </Box>
        </Flex>
      </Stack>
